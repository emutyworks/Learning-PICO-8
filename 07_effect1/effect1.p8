...
pc.smy = 0
	...
	bg_map = {
		...
		8, 0, 8, 0, 8, 0,10, 0,10, 0, 0, 9, 0, 0, 0, 8,
		8, 0, 0, 0, 8, 0, 0, 0,10, 0, 9, 0, 0, 0, 0, 8,
		8, 0, 8, 0, 8, 8, 8,10, 0,10, 9, 0, 9, 9, 0, 8,
		8, 0, 8, 0, 0, 8, 0, 0,10, 0, 0, 0, 0, 0, 0, 8,
...
function draw_shot(s)
	if collision_shot(s) then 
		...
		if (get_map(s.efmx, s.efmy) >= 11) and (get_map(s.efmx, s.efmy) <= 14)  then
			score += 20
			set_map(0, s.efmx, s.efmy)
		else
			if get_map(s.efmx, s.efmy) == 10 then
				score += 5
				if pc.s == 2 then
					set_map(11, s.efmx, s.efmy)-- Top
				elseif pc.s == 0 then
					set_map(13, s.efmx, s.efmy)-- Bottom
				elseif pc.s == 3 then
					set_map(12, s.efmx, s.efmy)-- Right
				elseif pc.s == 1 then
					set_map(14, s.efmx, s.efmy)-- Left
				end
			end
		end
...
__gfx__

